...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_OnlineSubsystemEIK_SendMessageToServer__DelegateSignature_Statics::NewProp_Message_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UDelegateFunction_OnlineSubsystemEIK_SendMessageToServer__DelegateSignature_Statics::NewProp_Message = { "Message", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_OnlineSubsystemEIK_eventSendMessageToServer_Parms, Message), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_OnlineSubsystemEIK_SendMessageToServer__DelegateSignature_Statics::NewProp_Message_MetaData), Z_Construct_UDelegateFunction_OnlineSubsystemEIK_SendMessageToServer__DelegateSignature_Statics::NewProp_Message_MetaData) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_OnlineSubsystemEIK_SendMessageToServer__DelegateSignature_Statics::Function_MetaDataParams[] = {
...
void FSendMessageToServer_DelegateWrapper(const FMulticastScriptDelegate& SendMessageToServer, TArray<uint8> const& Message)
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAntiCheatClient_IsAntiCheatClientAvailable_Statics::NewProp_WorldContextObject_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAntiCheatClient_IsAntiCheatClientAvailable_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AntiCheatClient_eventIsAntiCheatClientAvailable_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAntiCheatClient_IsAntiCheatClientAvailable_Statics::NewProp_WorldContextObject_MetaData), Z_Construct_UFunction_UAntiCheatClient_IsAntiCheatClientAvailable_Statics::NewProp_WorldContextObject_MetaData) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAntiCheatClient_IsAntiCheatClientAvailable_Statics::Function_MetaDataParams[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAntiCheatClient_RecievedMessageFromServer_Statics::NewProp_Message_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UAntiCheatClient_RecievedMessageFromServer_Statics::NewProp_Message = { "Message", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AntiCheatClient_eventRecievedMessageFromServer_Parms, Message), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAntiCheatClient_RecievedMessageFromServer_Statics::NewProp_Message_MetaData), Z_Construct_UFunction_UAntiCheatClient_RecievedMessageFromServer_Statics::NewProp_Message_MetaData) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAntiCheatClient_RecievedMessageFromServer_Statics::Function_MetaDataParams[] = {
		{ "Category", "EOS Integration Kit|AntiCheat" },
		{ "ModuleRelativePath", "AntiCheat/AntiCheatClient.h" },
	};
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAntiCheatClient_RegisterAntiCheatClient_Statics::Function_MetaDataParams[] = {
		{ "Category", "EOS Integration Kit|AntiCheat" },
		{ "ModuleRelativePath", "AntiCheat/AntiCheatClient.h" },
	};
#endif
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_OnSendMessageToServer_MetaData[];
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAntiCheatClient_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAntiCheatClient_IsAntiCheatClientAvailable, "IsAntiCheatClientAvailable" }, // 3688364659
		{ &Z_Construct_UFunction_UAntiCheatClient_RecievedMessageFromServer, "RecievedMessageFromServer" }, // 1404498966
		{ &Z_Construct_UFunction_UAntiCheatClient_RegisterAntiCheatClient, "RegisterAntiCheatClient" }, // 1817418195
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAntiCheatClient_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAntiCheatClient_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AntiCheat/AntiCheatClient.h" },
		{ "ModuleRelativePath", "AntiCheat/AntiCheatClient.h" },
	};
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAntiCheatClient_Statics::NewProp_OnSendMessageToServer_MetaData[] = {
		{ "Category", "EOS Integration Kit|AntiCheat" },
		{ "ModuleRelativePath", "AntiCheat/AntiCheatClient.h" },
	};
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAntiCheatClient_Statics::NewProp_OnSendMessageToServer = { "OnSendMessageToServer", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAntiCheatClient, OnSendMessageToServer), Z_Construct_UDelegateFunction_OnlineSubsystemEIK_SendMessageToServer__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAntiCheatClient_Statics::NewProp_OnSendMessageToServer_MetaData), Z_Construct_UClass_UAntiCheatClient_Statics::NewProp_OnSendMessageToServer_MetaData) }; // 2893979472
	...
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAntiCheatClient_Statics::StaticCppClassTypeInfo = {
	...
	UAntiCheatClient::~UAntiCheatClient() {}
	struct Z_CompiledInDeferFile_FID_RaptorRails_Plugins_EOSIntegrationKit_Source_OnlineSubsystemEIK_AntiCheat_AntiCheatClient_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RaptorRails_Plugins_EOSIntegrationKit_Source_OnlineSubsystemEIK_AntiCheat_AntiCheatClient_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAntiCheatClient, UAntiCheatClient::StaticClass, TEXT("UAntiCheatClient"), &Z_Registration_Info_UClass_UAntiCheatClient, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAntiCheatClient), 1215015490U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RaptorRails_Plugins_EOSIntegrationKit_Source_OnlineSubsystemEIK_AntiCheat_AntiCheatClient_h_3769460368(TEXT("/Script/OnlineSubsystemEIK"),
		Z_CompiledInDeferFile_FID_RaptorRails_Plugins_EOSIntegrationKit_Source_OnlineSubsystemEIK_AntiCheat_AntiCheatClient_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RaptorRails_Plugins_EOSIntegrationKit_Source_OnlineSubsystemEIK_AntiCheat_AntiCheatClient_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
